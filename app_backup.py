...
# ============================================================
# TASK SUGGESTION LIBRARY (Clause Generated)
# ============================================================
TASK_LIBRARY = {
    'beginner_cardio': [
...
def get_task_suggestions(user_id, existing_task_names=None):
...
def tasks():
    ...
    if db:
        ...
        suggested_tasks = get_task_suggestions(user_id, existing_task_names)
